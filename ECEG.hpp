...
public:
         ...
         */
        static void Enc(std::istream &pKey, std::istream &plain);
        /**
         ...
         */
        static void Dec(std::istream &sKey, std::istream &cipher);
	/**
         * @brief This procedure adds two ciphertexts on the elliptic curve.
         * @param[in] takes as input the data streams containing the secret key and the ciphertext respectively.
         */
        static void addCiphers(std::istream &cipherA, std::istream &cipherB);
        /**
